...
struct RenderSettings {
    ...
    var size : CGSize = CGSize(width: 600, height: 900)
    var fps: Float32 = 1   // frames per second
    ...
    init(imagesCount: Int) {
        self.fps = Float32(imagesCount)/3.0
    }
}
        ...
        PHPhotoLibrary.requestAuthorization { status in
            ...
            PHPhotoLibrary.shared().performChanges({
                ...
                if !success {
                    ...
                    photoLibrary.setVideo(at: 0, callback: { (item) in
                        NotificationCenter.default.post(name: NSNotification.Name("savedVideo"), object: self)
                    })
                }
            }
        }
...
//    }
    ...
    func appendPixelBuffers(writer: VideoWriter) -> Bool {
        ...
        let frameDuration = CMTimeMake(Int64(Float32(ImageAnimator.kTimescale) / settings.fps), ImageAnimator.kTimescale)
